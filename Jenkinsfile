        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        bat "scp  -i ${params.Senthil_M} ec2-user@35.168.2.91:**/target/*.war ec2-user@3.85.148.209:/var/lib/tomcat/webapps"
                    }
                }
 
                stage ("Deploy to Production"){
                    steps {
                        bat "scp -i ${params.Senthil_M} ec2-user@35.168.2.91:**/target/*.war ec2-user@35.168.2.91:/var/lib/tomcat/webapps"
                    }
                }
            }
        }
